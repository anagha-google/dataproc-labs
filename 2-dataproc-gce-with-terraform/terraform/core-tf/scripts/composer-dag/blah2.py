...
#phs_resource_uri="projects/"+project_id+"/regions/"+region+"/clusters/dpgce-sphs-"+project_nbr
phs_bucket_name="dpgce-sphs-"+project_nbr
#phs_conf="spark:spark.history.fs.logDirectory=gs://"+phs_bucket_name+"/*/spark-job-history,yarn:yarn.nodemanager.remote-app-log-dir=gs://"+phs_bucket_name+"/yarn-logs,mapred:mapreduce.jobhistory.done-dir=gs://"+phs_bucket_name+"/events/mapreduce-job-history/done,mapred:mapreduce.jobhistory.intermediate-done-dir=gs://"+phs_bucket_name+"/events/mapreduce-job-history/intermediate-done,spark:spark.eventLog.dir=gs://"+phs_bucket_name+"/events/spark-job-history" 
...
with models.DAG(
    ...
    create_dpgce_cluster = ClusterGenerator(
        ...
        properties=phs_conf,
        num_masters=1,
        master_machine_type=dpgce_cluster_master_type,
        master_disk_type="pd-standard",
        master_disk_size=1024,
        worker_machine_type=dpgce_cluster_worker_type,
        worker_disk_type=,
        worker_disk_size=,
